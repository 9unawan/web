...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme_contrast=""
    ...
    <!--================================ [ Sidebar Menu ]start ===========================-->
    {{-- @include('helpdesk.components.sidebar') --}}
    <!-- [ Sidebar Menu ] end -->


    <!--============================== [ Header Topbar ] start ==========================-->

    @include('helpdesk.components.hdheader')
    ...
    {{-- </div> --}}
    <!-- [ Main Content ] end -->
{{-- @include('helpdesk.components.footer') --}}
{{-- 
    <div class="pct-c-btn">
    ...
    {{-- @include('helpdesk.components.setting') --}}
    ...
    <script>layout_sidebar_change('true');</script>
